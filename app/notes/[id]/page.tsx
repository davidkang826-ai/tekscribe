      ...
      <main className="flex-1 min-h-0 overflow-y-auto overscroll-contain w-full max-w-3xl mx-auto px-5 pt-2 pb-28">
        ...
        {(note.customer_name ||
          ...
          <div className="mt-3 rounded-2xl border border-border bg-brand-50/60 p-4">
            <div className="text-[13px] font-semibold uppercase tracking-wide text-brand mb-2">
              Client
            </div>
            {note.customer_name && (
        ...
        {note.drive_folder_id && note.drive_synced_at && (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="tt-pop mt-3 inline-flex items-center gap-1.5 rounded-lg bg-green-50 px-3 py-1.5 text-[13px] font-medium text-success ring-1 ring-green-100 hover:bg-green-100 transition"
          >
              ...
              {attachments.map((a) =>
                a.type.startsWith("image/") ? (
                  ...
                  >
                    ...
                    <span className="text-[12px] text-muted truncate max-w-full">
                      {a.name}
                    </span>
                  </a>
                )
        ...
        <div className="mt-5">
          ...
          <div className="rounded-xl border border-border bg-surface p-4 text-[17px] leading-relaxed text-foreground whitespace-pre-wrap shadow-sm">
            {note.transcript}
          </div>
          {!summary && (
